...
window.I18N = (function () {
  const dict = {
    nl: {
      ...
      advanced: "Geavanceerd", cancel: "Annuleren",
      ...
      del_place_notifs: "Op {place} staat {n} melding(en). Die gaan mee weg. Doorgaan?",
      ...
      compass: "Kompas", compass_on: "Kompas aanzetten",
      compass_why: "Zonder kompas laat de kaart niet zien welke kant je op kijkt.",
      compass_denied: "Geen kompas: de kaart laat niet zien welke kant je op kijkt. Zet Motion & Orientation Access aan in de instellingen van je toestel en open de app opnieuw.",
    },
    en: {
      ...
      advanced: "Advanced", cancel: "Cancel",
      ...
      del_place_notifs: "{n} notification(s) on {place} will be removed too. Continue?",
      ...
      compass: "Compass", compass_on: "Turn on the compass",
      compass_why: "Without a compass the map cannot show which way you are facing.",
      compass_denied: "No compass: the map cannot show which way you are facing. Turn on Motion & Orientation Access in your device settings and open the app again.",
    },
  };
  let lang = "nl";
